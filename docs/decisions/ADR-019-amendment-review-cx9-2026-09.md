# ADR-019 Amendment 2026-09-19 -- adversarial review by CX9 (Codex / GPT), 2026-09

**Subject:** the ADR-019 amendment of 2026-09-19 (managers create and retire bots through the existing `workspace.create_bot` / `workspace.retire_bot` tools).

**Reviewer:** CX9 (Codex/GPT), a non-Anthropic model and therefore independent of the Claude author of the amendment. Task: TASK-310.

**Source:** written by CX9 in `dossiers/TASK-310.md` (builders never own `docs/**`); copied here verbatim by ORCH.
