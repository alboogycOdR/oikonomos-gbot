...
- **Builder roster (2026-09-24, Alister, revised): CX9 is the ONLY builder.** S5 was retired the same day because CX9's plan was upgraded, and GB was retired earlier. CX is inactive. The roster line in the DEVDEPARTMENT section below is stale, and this bullet overrides it. ORCH does coordination, orchestration and review only, never building. CX9 is non-Claude, so ORCH (Claude) is a valid different-model reviewer for its protected-path work.
